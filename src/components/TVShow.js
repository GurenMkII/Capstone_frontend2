...
export default class TVShow extends Component {
    ...
    componentDidMount() {
        ...
        fetch("https://api.themoviedb.org/3/tv/popular?api_key=b644ab6b14fc5346cabffe34357d92a0&language=en-US&page="+this.state.pagenum)
    ...
    redirect(tv) {
        localStorage.setItem('title', JSON.stringify(tv));
